...
const blank=(companyId:string,companyName:string):Product=>({id:'',companyId,companyName,sku:'',barcode:'',name:'',openingStock:0,received:0,shipped:0,returned:0,stock:0,minStock:20,status:'OK',sourceFile:'Added in app',isActive:true});
